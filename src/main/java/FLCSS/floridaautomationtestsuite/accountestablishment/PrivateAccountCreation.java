 ...
 * THEN Private Account is created successfully
...
public class PrivateAccountCreation extends AbstractClearSkyTest {
  ...
  @Test (
    ...
    description = "THEN Private Account is created successfully"
  )
  @ClearSkyTestMethod (stepNumber = 1)
  public void THEN_Private_Account_is_created_successfully_0001(BaseUrl baseUrl, DataTable dataTable, Settings settings) {
    LOG.info("Test Execution : Scenario[Private Account creation], Step[0 : THEN Private Account is created successfully]");
   ...
   */
  @Test (
    dependsOnMethods = "THEN_Private_Account_is_created_successfully_0001",
    dataProvider = "getStepParameters",
    dataProviderClass = ClasspathDataProvider.class,
  ...
  public void WHEN_We_enter_the_required_fields_and_create_the_account_0002(BaseUrl baseUrl, DataTable dataTable, Settings settings) {
    LOG.info("Test Execution : Scenario[Private Account creation], Step[1 : WHEN We enter the required fields and create the account]");
    throw new NotYetImplementedException();
  }
}
